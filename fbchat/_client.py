...
class Client(object):
    ...
    def sendReply(self, message, message_id, thread_id=None, thread_type=ThreadType.USER):
        """Deprecated. Use :func:`fbchat.Client.send` instead."""
        return self.send(
            Message(text=message, reply_to_id=message_id), thread_id=thread_id, thread_type=thread_type
        )
